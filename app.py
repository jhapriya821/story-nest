...
with st.sidebar:
    ...
    # CRITICAL: Replace with your number including country code (e.g., 49176...)
    # NO spaces, NO '+' sign. Example: "491761234567"
    my_phone = "YOUR_NUMBER_HERE" 
    
    msg = "Hi! I'd like a long story for Story Nest! My name is ____ and I love ____."
    # Using the 'wa.me' format prevents the 404 error you see in Screenshot 6
...
with tab1:
    if is_admin:
        ...
        if st.button("Generate Story ✨"):
            # --- FULL MEGA-STORY ENGINE (RESTORED) ---
