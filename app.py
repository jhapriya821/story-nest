...
with st.sidebar:
    ...
    # IMPORTANT: Replace with your number (e.g., 49176...) No spaces, no +
        ...
        if st.button("Generate Story ✨"):
            ...
            with col_img:
                if img_path and os.path.exists(img_path):
                    ...
                    st.warning(f"⚠️ Image not found in 'assets' folder!")
            
            save_to_library(kid_name, full_story, img_path)
            st.balloons()
    else:
        st.info("Enter Admin Password to Create.")
