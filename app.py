...
with st.sidebar:
    ...
    # REPLACE WITH YOUR NUMBER: No spaces, no + (e.g., "491761234567")
...
with tab1:
    if is_admin:
        ...
        if st.button("Generate Story ✨"):
            # --- THE MEGA-STORY ENGINE (500 WORDS PER WORLD) ---
...
with tab2:
    ...
    if not rows:
        st.info("The library is empty. Generate a story in the first tab to save it here!")
    else:
